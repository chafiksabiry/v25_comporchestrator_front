...
function App() {
  ...
  useEffect(() => {
    ...
    // activeTab persistence removed per user request
            ...
            <div className="flex w-full items-center justify-between">
              ...
              <div className="flex items-center space-x-4 ml-auto">
                <div className="flex items-center space-x-3 bg-gray-50 p-1.5 pr-4 rounded-2xl border border-gray-100 shadow-sm">
                  <div className="h-100 w-100 rounded-xl bg-gradient-harx flex items-center justify-center text-white font-black shadow-md">
