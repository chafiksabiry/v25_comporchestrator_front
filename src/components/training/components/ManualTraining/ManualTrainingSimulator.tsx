...
const API_BASE = import.meta.env.VITE_API_TRAINING_URL ||
  (() => {
...
export default function ManualTrainingSimulator({
  ...
  if (loading) {
    return (
      <div className="min-h-full bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
