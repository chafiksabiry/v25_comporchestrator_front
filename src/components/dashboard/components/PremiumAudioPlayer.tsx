...
export function PremiumAudioPlayer({ url }: PremiumAudioPlayerProps) {
  ...
  return (
    <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl p-4 border border-white/10 shadow-2xl flex items-center gap-6 w-full group">
      ...
      <button
        onClick={togglePlay}
        className="w-12 h-12 rounded-2xl bg-orange-500 text-white flex items-center justify-center shadow-lg shadow-orange-500/20 hover:scale-110 transition-all shrink-0"
      >
            ...
            return (
              <div
                ...
                className={`flex-1 rounded-full transition-all duration-300 ${
                  isPlayed ? 'bg-orange-400' : 'bg-slate-700'
                }`}
