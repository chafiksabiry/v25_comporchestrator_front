...
**Error Message:**
```
PUT https://prod-api-companysearchwizard.harx.ai/api/onboarding/companies/undefined/onboarding/phases/2/steps/5 500 (Internal Server Error)
```
...
```env
VITE_COMPANY_API_URL=https://prod-api-companysearchwizard.harx.ai
